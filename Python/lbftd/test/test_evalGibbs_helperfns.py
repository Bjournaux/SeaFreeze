...
class TestEvalGibbsHelperFns(ut.TestCase):
    ...
    def test_buildEvalArgs_derivsCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs='foo', PTM=None, gPTM=None, tdvout=None, gibbsSp=None, f=None)
    ...
    def test_buildEvalArgs_gridCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM='foo', tdvout=None, gibbsSp=None, f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_MWvCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM=None, tdvout=None, gibbsSp={'MW': list(['foo', 'foo2'])}, f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_MWuCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM=None, tdvout=None, gibbsSp={'MW': list(['foo1', 'foo'])}, f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_nuCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM=None, tdvout=None, gibbsSp={'nu': 'foo'},
                                    f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_TDVCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM=None, tdvout='foo', gibbsSp=None, f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_splineCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM=None, tdvout=None, gibbsSp='foo', f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_PTMCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM='foo', gPTM=None, tdvout=None, gibbsSp=None, f=None)
        self.assertEqual(1, len(fooargs))
    ...
    def test_buildEvalArgs_FCustomParm(self):
        ...
        fooargs = eg._buildEvalArgs(tdv, derivs=None, PTM=None, gPTM=None, tdvout=None, gibbsSp=None, f='foo')
        self.assertEqual(1, len(fooargs))
