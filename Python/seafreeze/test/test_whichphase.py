...
class TestWhichPhase(ut.TestCase):
    ...
    def test_scatter_singlePt(self):
        ...
        self.assertEqual(6, sf.whichphase(PT, 'water1', '/Users/ulajones/PycharmProjects/SeaFreeze/Python/seafreeze/SeaFreeze_Gibbs.mat')[0])
    def test_scatter_multiPt(self):
        PT = np.empty((3,), object)
        PT[0] = (100, 200)
        PT[1] = (400, 250)
        PT[2] = (1000, 300)
        out = sf.whichphase(PT, '../../../seafreeze/SeaFreeze_Gibbs.mat')
    ...
    def test_scatter_all_extrapolations(self):
        ...
        np.testing.assert_array_equal([np.nan, np.nan, np.nan], sf.whichphase(PT, '../../../Python/seafreeze/SeaFreeze_Gibbs.mat'))
    def test_grid(self):
        P = np.arange(0, 1001, 200)
        T = np.arange(200, 351, 50)
        exp = np.array([[1, 1, 0, 0], [2, 1, 0, 0], [2, 5, 0, 0], [2, 5, 0, 0], [6, 6, 0, 0], [6, 6, 6, 0]], dtype=object)
        act = sf.whichphase(np.array([P, T], dtype=object), 'water1', '../../../Python/seafreeze/SeaFreeze_Gibbs.mat')
    ...
    def test_phases(self):
        ...
        act = sf.whichphase(PT, 'water1', '../../../Python/seafreeze/SeaFreeze_Gibbs_VII.mat')
