...
%   material - phase name; any NaClaq variant triggers the 3D (P,T,m)
%              requirement, everything else expects 2D (P,T).

defs = sf_material_defs();
is_solution = ismember(material, defs.nacl_materials);
