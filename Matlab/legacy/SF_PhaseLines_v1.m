function out=SF_PhaseLines_v1(material_1, material_2, varargin)
    %v. 1.0 Clinton & Journaux, 2020 — frozen baseline kept for regression
    %comparison against the rewritten SF_PhaseLines. Do not modify.
